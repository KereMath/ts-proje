...
|---|---|
| Toplam test | 380 |
| Full match | 357 (93.95%) |
| Partial match | 21 (5.5%) |
| No match | 2 (0.5%) |
...
| 3 | stochastic_trend | stochastic_trend | 10 | 8 | 1 | 1 | %80 |
| 4 | volatility | volatility | 10 | 9 | 1 | 0 | %90 |
| 5 | collective_anomaly | stationary + collective_anomaly | 10 | 10 | 0 | 0 | %100 |
| 7 | mean_shift | stationary + mean_shift | 10 | 8 | 2 | 0 | %80 |
| 8 | point_anomaly | stationary + point_anomaly | 10 | 8 | 2 | 0 | %80 |
| 9 | trend_shift | stationary + trend_shift | 10 | 8 | 2 | 0 | %80 |
| 10 | variance_shift | stationary + variance_shift | 10 | 9 | 1 | 0 | %90 |
...
| 14 | cubic+variance_shift | deterministic_trend + variance_shift | 10 | 9 | 1 | 0 | %90 |
...
| 20 | exp+mean_shift | deterministic_trend + mean_shift | 10 | 10 | 0 | 0 | %100 |
...
| 24 | linear+mean_shift | deterministic_trend + mean_shift | 10 | 10 | 0 | 0 | %100 |
| 25 | linear+point_anomaly | deterministic_trend + point_anomaly | 10 | 10 | 0 | 0 | %100 |
| 26 | linear+trend_shift | deterministic_trend + trend_shift | 10 | 7 | 2 | 1 | %70 |
...
| 31 | quad+variance_shift | deterministic_trend + variance_shift | 10 | 10 | 0 | 0 | %100 |
...
| 34 | stoch+point_anomaly | stochastic_trend + point_anomaly | 10 | 8 | 2 | 0 | %80 |
| 35 | stoch+variance_shift | stochastic_trend + variance_shift | 10 | 9 | 1 | 0 | %90 |
| 36 | vol+collective | volatility + collective_anomaly | 10 | 10 | 0 | 0 | %100 |
| 37 | vol+mean_shift | volatility + mean_shift | 10 | 8 | 2 | 0 | %80 |
| 38 | vol+point_anomaly | volatility + point_anomaly | 10 | 10 | 0 | 0 | %100 |
| 39 | vol+variance_shift | volatility + variance_shift | 10 | 10 | 0 | 0 | %100 |
...
| `Stochastic Trend` | `stochastic_trend_06.csv` | `deterministic_trend` | x NONE |
...
| `mean_shift` | `mean_shift_00.csv` | `deterministic_trend + mean_shift` | ~ PARTIAL |
| `mean_shift` | `mean_shift_03.csv` | `stationary + mean_shift` | FULL |
| `mean_shift` | `mean_shift_06.csv` | `volatility + mean_shift` | ~ PARTIAL |
| `mean_shift` | `mean_shift_02.csv` | `stationary + mean_shift` | FULL |
| `mean_shift` | `mean_shift_08.csv` | `stationary + mean_shift` | FULL |
| `mean_shift` | `mean_shift_09.csv` | `stationary + mean_shift` | FULL |
...
| `point_anomaly` | `point_anomaly_08.csv` | `stationary` | ~ PARTIAL |
| `point_anomaly` | `point_anomaly_03.csv` | `stationary + point_anomaly` | FULL |
| `point_anomaly` | `point_anomaly_00.csv` | `volatility + point_anomaly` | ~ PARTIAL |
...
| Leaf | CSV | Tahmin | Sonuc |
|---|---|---|---|
| `trend_shift` | `trend_shift_08.csv` | `stationary + trend_shift` | FULL |
| `trend_shift` | `trend_shift_03.csv` | `stationary + trend_shift` | FULL |
| `trend_shift` | `trend_shift_02.csv` | `stationary + trend_shift` | FULL |
| `trend_shift` | `trend_shift_09.csv` | `volatility + trend_shift` | ~ PARTIAL |
| `trend_shift` | `trend_shift_06.csv` | `stationary + trend_shift` | FULL |
| `trend_shift` | `trend_shift_07.csv` | `stationary + trend_shift` | FULL |
| `trend_shift` | `trend_shift_01.csv` | `stationary + trend_shift` | FULL |
| `trend_shift` | `trend_shift_04.csv` | `stationary` | ~ PARTIAL |
| `trend_shift` | `trend_shift_05.csv` | `stationary + trend_shift` | FULL |
| `trend_shift` | `trend_shift_00.csv` | `stationary + trend_shift` | FULL |
---
...
| `variance_shift` | `variance_shift_01.csv` | `volatility + variance_shift` | ~ PARTIAL |
...
| `cubic_collective_anomaly` | `cubic_collective_04.csv` | `deterministic_trend + collective_anomaly` | FULL |
...
| `Cubic + Point Anomaly` | `cubic_point_anomaly_00.csv` | `deterministic_trend + point_anomaly` | FULL |
...
| `Cubic + Variance Shift` | `cubic_variance_shift_00.csv` | `stochastic_trend + mean_shift + variance_shift` | ~ PARTIAL |
...
| `Damped + Collective Anomaly` | `damped_collective_06.csv` | `deterministic_trend + collective_anomaly` | FULL |
...
| `Damped + Mean Shift` | `damped_mean_shift_03.csv` | `deterministic_trend + mean_shift + variance_shift` | FULL |
| `Damped + Mean Shift` | `damped_mean_shift_02.csv` | `deterministic_trend + mean_shift` | FULL |
| `Damped + Mean Shift` | `damped_mean_shift_07.csv` | `deterministic_trend + mean_shift` | FULL |
| `Damped + Mean Shift` | `damped_mean_shift_01.csv` | `deterministic_trend + mean_shift` | FULL |
| `Damped + Mean Shift` | `damped_mean_shift_04.csv` | `deterministic_trend + mean_shift` | FULL |
...
| `Damped + Variance Shift` | `damped_variance_shift_08.csv` | `deterministic_trend + variance_shift` | FULL |
...
| `Damped + Variance Shift` | `damped_variance_shift_00.csv` | `deterministic_trend + variance_shift` | FULL |
---
...
| `exponential_collective_anomaly` | `exp_collective_03.csv` | `deterministic_trend + collective_anomaly` | FULL |
...
| `exponential_collective_anomaly` | `exp_collective_05.csv` | `deterministic_trend + collective_anomaly` | FULL |
...
| `Exponential + Mean Shift` | `exp_mean_shift_07.csv` | `deterministic_trend + mean_shift` | FULL |
...
| `Linear + Mean Shift` | `linear_mean_shift_00.csv` | `deterministic_trend + mean_shift` | FULL |
...
| `Linear + Trend Shift` | `linear_trend_shift_00.csv` | `deterministic_trend + trend_shift` | FULL |
| `Linear + Trend Shift` | `linear_trend_shift_01.csv` | `stationary + trend_shift` | ~ PARTIAL |
| `Linear + Trend Shift` | `linear_trend_shift_06.csv` | `stationary + trend_shift` | ~ PARTIAL |
| `Linear + Trend Shift` | `linear_trend_shift_07.csv` | `deterministic_trend + trend_shift + variance_shift` | FULL |
...
| `Linear + Trend Shift` | `linear_trend_shift_09.csv` | `deterministic_trend + trend_shift` | FULL |
---
...
| `Quadratic + Collective anomaly` | `quad_collective_02.csv` | `deterministic_trend + collective_anomaly` | FULL |
...
| `Quadratic + Mean Shift` | `quad_mean_shift_04.csv` | `deterministic_trend` | ~ PARTIAL |
| `Quadratic + Mean Shift` | `quad_mean_shift_06.csv` | `deterministic_trend + mean_shift` | FULL |
| `Quadratic + Mean Shift` | `quad_mean_shift_01.csv` | `deterministic_trend + mean_shift` | FULL |
| `Quadratic + Mean Shift` | `quad_mean_shift_08.csv` | `deterministic_trend + mean_shift` | FULL |
| `Quadratic + Mean Shift` | `quad_mean_shift_02.csv` | `deterministic_trend + mean_shift` | FULL |
| `Quadratic + Mean Shift` | `quad_mean_shift_03.csv` | `deterministic_trend + mean_shift + trend_shift` | FULL |
| `Quadratic + Mean Shift` | `quad_mean_shift_05.csv` | `deterministic_trend + mean_shift + trend_shift` | FULL |
---
...
| Leaf | CSV | Tahmin | Sonuc |
|---|---|---|---|
| `Quadratic + Variance Shift` | `quad_variance_shift_06.csv` | `deterministic_trend + mean_shift + variance_shift` | FULL |
| `Quadratic + Variance Shift` | `quad_variance_shift_08.csv` | `deterministic_trend + variance_shift` | FULL |
| `Quadratic + Variance Shift` | `quad_variance_shift_05.csv` | `deterministic_trend + variance_shift` | FULL |
| `Quadratic + Variance Shift` | `quad_variance_shift_02.csv` | `deterministic_trend + variance_shift` | FULL |
| `Quadratic + Variance Shift` | `quad_variance_shift_01.csv` | `deterministic_trend + variance_shift` | FULL |
...
| `Stochastic Trend + Mean Shift` | `stoch_mean_shift_04.csv` | `stochastic_trend + variance_shift` | ~ PARTIAL |
...
| `Stochastic Trend + Mean Shift` | `stoch_mean_shift_07.csv` | `deterministic_trend + mean_shift` | ~ PARTIAL |
---
...
| `Stochastic Trend + Point Anomaly` | `stoch_point_anomaly_08.csv` | `deterministic_trend + point_anomaly` | ~ PARTIAL |
| `Stochastic Trend + Point Anomaly` | `stoch_point_anomaly_04.csv` | `stochastic_trend + point_anomaly` | FULL |
| `Stochastic Trend + Point Anomaly` | `stoch_point_anomaly_09.csv` | `stochastic_trend + point_anomaly` | FULL |
...
| `Stochastic Trend + Point Anomaly` | `stoch_point_anomaly_02.csv` | `stochastic_trend + point_anomaly` | FULL |
| `Stochastic Trend + Point Anomaly` | `stoch_point_anomaly_01.csv` | `deterministic_trend + point_anomaly` | ~ PARTIAL |
...
| Leaf | CSV | Tahmin | Sonuc |
|---|---|---|---|
| `Stochastic Trend + Variance Shift` | `stoch_variance_shift_02.csv` | `deterministic_trend + variance_shift` | ~ PARTIAL |
...
| `Volatility + Collective Anomaly` | `vol_collective_00.csv` | `volatility + collective_anomaly + point_anomaly` | FULL |
...
| `Volatility + Collective Anomaly` | `vol_collective_06.csv` | `volatility + collective_anomaly` | FULL |
---
...
| Leaf | CSV | Tahmin | Sonuc |
|---|---|---|---|
| `Volatility + Mean Shift` | `vol_mean_shift_00.csv` | `volatility + mean_shift` | FULL |
| `Volatility + Mean Shift` | `vol_mean_shift_09.csv` | `deterministic_trend + mean_shift` | ~ PARTIAL |
| `Volatility + Mean Shift` | `vol_mean_shift_05.csv` | `volatility + mean_shift` | FULL |
| `Volatility + Mean Shift` | `vol_mean_shift_06.csv` | `deterministic_trend + mean_shift` | ~ PARTIAL |
...
| `Volatility + Mean Shift` | `vol_mean_shift_03.csv` | `volatility + mean_shift` | FULL |
...
| `Volatility + Point Anomaly` | `vol_point_anomaly_05.csv` | `volatility + point_anomaly` | FULL |
| `Volatility + Point Anomaly` | `vol_point_anomaly_07.csv` | `volatility + point_anomaly` | FULL |
...
| `Volatility + Variance Shift` | `vol_variance_shift_03.csv` | `volatility + variance_shift` | FULL |
---
