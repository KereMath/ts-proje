...
Toplam 33 realdata dosyasi pipeline'dan gecti.
...
|---|---|---|---|---|---|---|
| W12-1.csv | 54 | combo_suppress | stationary | - | 0.003 | 0.946 |
| W12-2.csv | 54 | combo_suppress | stationary | - | 0.002 | 0.969 |
| W5.csv | 71 | combo | deterministic_trend | collective_anomaly, contextual_anomaly | 0.001 | 0.995 |
| deaths.csv | 72 | combo | stationary | contextual_anomaly | 0.004 | 0.998 |
...
| W13-3.csv | 82 | combo | deterministic_trend | collective_anomaly, contextual_anomaly | 0.002 | 0.994 |
| W13-4.csv | 82 | combo | deterministic_trend | contextual_anomaly | 0.005 | 0.998 |
| W13-5.csv | 82 | combo | deterministic_trend | collective_anomaly, contextual_anomaly | 0.002 | 0.990 |
| W3.csv | 82 | combo | stationary | collective_anomaly, contextual_anomaly | 0.002 | 0.992 |
...
| e1.csv | 92 | combo | stochastic_trend | collective_anomaly, contextual_anomaly | 0.003 | 0.989 |
...
| US_investment.csv | 104 | combo_suppress | stationary | - | 0.001 | 0.994 |
...
| rec_dataframe.csv | 453 | combo | deterministic_trend | contextual_anomaly, point_anomaly | 0.002 | 0.984 |
...
| NP_xetradax_returns100.csv | 1028 | combo_suppress | stationary | - | 0.006 | 0.992 |


## Base Type Dagilimi

```
deterministic_trend    23
stationary              6
stochastic_trend        3
volatility              1
```
...
|---|---|---|---|---|
| W12-1.csv | 54 | stationary | - | combo_suppress |
| W12-2.csv | 54 | stationary | - | combo_suppress |
| W5.csv | 71 | deterministic_trend | collective_anomaly, contextual_anomaly | combo |
| deaths.csv | 72 | stationary | contextual_anomaly | combo |
...
| W3.csv | 82 | stationary | collective_anomaly, contextual_anomaly | combo |
